...
Before starting implementation, I'll ask up to 4 clarifying questions with 3 options each to ensure we build exactly what you need.

### Question Template Pattern:
1. **Question about scope/boundaries**
   - Option A: Minimal implementation
   - Option B: Standard implementation with common features
   - Option C: Full implementation with advanced features

2. **Question about data relationships**
   - Option A: Simple entity with no relationships
   - Option B: Entity with basic relationships
   - Option C: Complex entity with multiple relationships

3. **Question about business rules**
   - Option A: Basic CRUD operations only
   - Option B: CRUD with simple validation
   - Option C: Complex business logic with multiple rules

4. **Question about integration needs**
   - Option A: Standalone feature
